...
{% timeline ## 2020,color %}
<!-- timeline ### **2020 Net-Ease High School MiniGame Competition - 前世今生狩猎小队** -->
{% videos, 2 %}
...
<!-- timeline ### **West 2 Online Third Round Assessment - Big watermelon** -->
...
<!-- timeline ### **West2Online Fourth Round Assessment - Arknights Remake** -->
![](image.png)
{% label Full-Stack green %}
...
{% timeline ## 2021,color %}
<!-- timeline ### **West2Online Fifth Round Assessment - 幽港疑云** -->
![](幽港疑云.jpg)
...
<!-- timeline ### **2021 Net-Ease High School MiniGame Competition - 翻转剧场** -->
{% videos,2 %}
...
<!-- timeline ### **West2Online Sixth Round Assessment - 深网防线** -->
...
{% timeline ## 2022,color %}
<!-- timeline ### **Ludum Dare 49 - Babel Blocks** -->
...
<!-- timeline ### Douyin Game-type Video Effects Development - 宅家舞蹈秀 -->
![](HomeShow.png)
...
<!-- timeline ### Bytedance IC Hackthon 2022 - Linsten in the Dark -->
![](listen_in_dark.png)
...
<!-- timeline ### 2022 China College Computer Competition WeChat Mini Program Application Development Competition - 话榕 -->
![](登陆注册.png)
...
{% timeline ## 2023,color %}
<!-- timeline ### Undergraduate FYP - StarWay  -->
...
<!-- timeline ### 3rd Game for Good Game Jam - Hold On！ -->
...
<!-- timeline ### Gcores BOOOM Game Jam - 信徒 -->
...
<!-- timeline ### Game Design Course Final Project - Ape Evolution -->
...
<!-- timeline ### Graduate FYP - One Last Interview -->
...
# Modules/Functions
{% timeline ## 2022,color %}
<!-- timeline ### Voice Recognition + Facial Expression Change Based on Unity -->
...
<!-- timeline ### 3D Model Clipping Effect Based on Depth Testing -->
![](aabb.png)
...
<!-- timeline ### Water Rendering and Interactive Water Implementation Based on Unity -->
...
{% timeline ## 2023,color %}
<!-- timeline ### Desktop Audio Application Based on Unity -->
![](audio.png)
...
# Others
{% timeline ## 2024,color %}
<!-- timeline ### Translation of "The Shader Bible" -->
![](USB.png)
...
<!-- timeline ### Procedural Modeling Attempt Based on Blender Geometry Nodes -->
![](flower.png)
